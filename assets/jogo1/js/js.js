function start() { // Inicio da função start()
    ...
    jogo.timer = setInterval(loop, 30);//aqui pega a versao modificada do movefundo e faz um loop com ela, ai sempre ela vai estar em movimento. no caso ai esta 30 milisegundos se colocar 10 ele vai ficar mais rapido.
    ...
    function movefundo() {
        ...
        esquerda = parseInt($("#fundoGame").css("background-position")); // transforma o background em um numero e a posicao atual dele sempre sera 0
        $("#fundoGame").css("background-position", esquerda - 1);//aqui pega e modifica o 0 para -1
